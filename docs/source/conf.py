...
html_theme_options = {
    ...
    "github_url": "https://github.com/INGV/ScatCluster",
    "announcement": "This is a beta release of the scatcluster package. Please report any issues you find <a href=https://github.com/INGV/ScatCluster/issues>in the GitHub repository</a>.",
}
